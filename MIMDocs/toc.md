...
## [Best practices](mim-best-practices.md)（最佳做法）
...
## [授权和下载](microsoft-identity-manager-licensing.md)
## [数据处理](mim-privacy-compliance.md)
## [在 TLS 1.2 或 FIPS 模式环境中部署](preparing-tls.md)
## [首次部署](microsoft-identity-manager-deploy.md)
### [域设置](preparing-domain.md)
### [GMSA 的域设置](preparing-domain-gmsa.md)
...
## [升级到 MIM 2016 SP2](microsoft-identity-manager-2016-service-pack-2-upgrade-path.md)
## [安装 MIM 证书管理](mim-cm-deploy.md)
## [BHOLD 安装主题](./bhold/bhold-installation-guide.md)
### [BHOLD 核心安装](./bhold/bhold-core-installation.md)
### [BHOLD 集成安装](./bhold/bhold-integration-installation.md)
### [BHOLD 证明安装](./bhold/bhold-attestation-installation.md)
### [BHOLD 模型生成器安装](./bhold/bhold-model-generator-installation.md)
### [BHOLD 报表安装](./bhold/bhold-reporting-installation.md)
### [BHOLD 分析安装](./bhold/bhold-analytics-installation.md)
### [BHOLD 访问管理连接器安装](./bhold/bhold-access-management-connector-install.md)
...
## [为 B2B 配置图形连接器](microsoft-identity-manager-2016-graph-b2b-scenario.md)
## [在 PAM 或 SSPR 中使用 Azure MFA 服务器](working-with-mfaserver-for-mim.md)
## [在 PAM 或 SSPR 中使用自定义 MFA 提供程序](working-with-custommfaserver-for-mim.md)
...
# 管理基础结构
## [最佳做法分析器](https://technet.microsoft.com/library/jj203402)
...
### BHOLD
#### [BHOLD 概念指南](./bhold/bhold-concepts-guide.md)
## 版本历史记录
...
### [通用 SQL 分步指南](./reference/microsoft-identity-manager-2016-connector-genericsql-step-by-step.md)
