...
## [什么是 MIM 2016？](/microsoft-identity-manager/understand-explore/microsoft-identity-manager-2016)
## [Service Pack 1 新增功能](/microsoft-identity-manager/understand-explore/Microsoft-identity-manager-2016-sp1-release-notes)
### [MIM2016 SP1 PAM 部署脚本](/microsoft-identity-manager/understand-explore/sp1-deployment-scripts)
## [Azure 中的混合报告](/microsoft-identity-manager/understand-explore/identity-manager-hybrid-reporting-azure)
# [规划和设计](/microsoft-identity-manager/plan-design/microsoft-identity-manager-2016-supported-platforms)
## [支持的平台](/microsoft-identity-manager/plan-design/microsoft-identity-manager-2016-supported-platforms)
## [连接到目录](/microsoft-identity-manager/plan-design/supported-management-agents)
## [容量规划](/microsoft-identity-manager/plan-design/capacity-planning-guide)
## [部署拓扑](/microsoft-identity-manager/plan-design/topology-considerations)
# [部署和使用](/microsoft-identity-manager/deploy-use/microsoft-identity-manager-deploy)
## [首次部署](/microsoft-identity-manager/deploy-use/microsoft-identity-manager-deploy)
### [域设置](/microsoft-identity-manager/deploy-use/preparing-domain)
### [服务器设置：Windows Server](/microsoft-identity-manager/deploy-use/prepare-server-ws2012r2)
### [服务器设置：SQL](/microsoft-identity-manager/deploy-use/prepare-server-sql2014)
### [服务器设置：SharePoint](/microsoft-identity-manager/deploy-use/prepare-server-sharepoint)
### [服务器设置：Exchange](/microsoft-identity-manager/deploy-use/prepare-server-exchange)
### [安装 MIM：同步](/microsoft-identity-manager/deploy-use/install-mim-sync)
### [安装 MIM：服务和门户](/microsoft-identity-manager/deploy-use/install-mim-service-portal)
### [安装 MIM：同步数据库](/microsoft-identity-manager/deploy-use/install-mim-sync-ad-service)
## [从 Forefront Identity Manager 2010 R2 升级](/microsoft-identity-manager/deploy-use/microsoft-identity-manager-2016-upgrade-from-fim-2010-R2)
## [密码更改通知服务](/microsoft-identity-manager/deploy-use/deploying-mim-password-change-notification-service-on-domain-controller)
## [Identity Manager 混合报告](/microsoft-identity-manager/deploy-use/working-with-identity-manager-hybrid-reporting)
## [自助服务密码重置](/microsoft-identity-manager/deploy-use/working-with-self-service-password-reset)
## [MIM 证书管理器](/microsoft-identity-manager/deploy-use/working-with-mim-certificate-manager)
### [注册智能卡](/microsoft-identity-manager/deploy-use/certificate-manager-for-non-administrators)
### [创建软件证书](/microsoft-identity-manager/deploy-use/certificate-manager-for-software-certificates)
...
## [Microsoft Identity Manager 2016 开发人员参考](/microsoft-identity-manager/reference/microsoft-identity-manager-2016-developer-reference)
